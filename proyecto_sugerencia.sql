...
CREATE TABLE `sugerencia` (
  ...
  `exhibidor` varchar(50) NOT NULL,
  `colgadera` varchar(50) NOT NULL,
  `Otros` int(10) NOT NULL,
  `Cliente_Cod_cli` varchar(50) NOT NULL,
  PRIMARY KEY (`IdSugerencia`),
  KEY `FKSugerencia835001` (`Cliente_Cod_cli`),
  CONSTRAINT `FKSugerencia835001` FOREIGN KEY (`Cliente_Cod_cli`) REFERENCES `cliente` (`Cod_cli`)
