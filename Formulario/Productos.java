 ...
 * Productos.java
 *
 * Created on 12-abr-2013, 8:14:37
 */
package Formulario;
...
//        FacturaC.txtigv.setText(""+Math.rint(igv*100)/100);
...
void mostrarproductosespeciales(String valor)    {
        ...
        String Sql="select * FROM productoespecial WHERE ClienteCod_cli LIKE '%"+valor+"%'";
        ...
        try {
             ...
             while(rs.next())
             {
                 ...
                 Registros[5]=rs.getString("Sugerido");   
...
// TODO add your handling code here:
     mostrarproductosespeciales( txtprod.getText());
      ...
      try {
         ...
         else
         {
                      ...
                      for(int i=0;i<Factura1.tbdet.getRowCount();i++)
          {
            ...
            {
                j=i;
                Factura1.tbdet.setValueAt(cant, i, 4);
                c=c+1;
          ...
          System.out.println("Formulario.Productos.mnenviarproActionPerformed()"+e);
    }
